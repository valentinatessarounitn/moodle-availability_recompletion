YUI.add('moodle-availability_recompletion-form', function (Y, NAME) {
    ...
    // String show inside Settings/Restrict access/Access restrictions
    M.availability_recompletion.form.getNode = function(json) {
        // Create HTML structure.

        // todo replace hardcoded string with dinamic one
        //var description = M.util.get_string('title', 'availability_recompletion');
        var description = M.util.get_string('short_description', 'availability_recompletion');

        // var description = 'Student has completed this course and the certification has expired';
